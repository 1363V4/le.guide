...
you can continue to trade blows. and i did.
...
the best video you're going to see about ecs
is [this one](https://www.youtube.com/watch?v=WwkuAqObplU). please watch it.

i mentioned 
[the array library](https://docs.python.org/fr/3/library/array.html)
earlier.
because i love python,
and i try to write python **as a c wrapper**
as much as possible.
...
easier to store, easier to load,
and paradoxically, easier to reason about.
...
next up: 
[a practical look](https://blog.legires.fr/2025/11/29/good_class3.html)
at dod in python.
