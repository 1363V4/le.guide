...
(and by the end of this article, you will know how to make yours too!)

something like **this**:

<video width="100%" controls muted style="filter: invert(1)">
  <source src="/mp4/pyglet0.mp4" type="video/mp4">
...
<video width="100%" controls muted style="filter: invert(1)">
  <source src="/mp4/pyglet1.mp4" type="video/mp4">
  Your browser does not support the video tag.
</video>
...
but before diving in i made a quick google search
and found **pyglet**.
...
capture the window with obs,
then use the 
"alpha key" 
feature of obs to remove the blue.

it's kinda heavy on the processor.
there's a better way to do it, maybe?

anyway, let's go and draw a background.
the way we *connoisseurs* of the art do it
...
okay, you like pyglet but why should **i** use it?

especially when i could use a real(tm) video game editor
like unity or stuff like that?

good spot. it's because i think there is
**a secret superpower** to using pyglet...
