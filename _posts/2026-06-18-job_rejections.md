...
(which was during covid, ok not the best time to job hunt).

i figured i'd list
every place i was rejected from.

for every job, i did a tailored cv
(and short motivation letter if needed).
did the interviews (phone, teams, coding...),
went in person if needed...

this might not be exhaustive,
i just searched "candidature" on my mail box.
...
older stuff 2021/2020 (i was getting tired):
